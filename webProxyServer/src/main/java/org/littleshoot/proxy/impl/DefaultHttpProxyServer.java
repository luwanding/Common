    ...
    private static class DefaultHttpProxyServerBootstrap implements HttpProxyServerBootstrap {
        ...
        private DefaultHttpProxyServerBootstrap(Properties props) {
            ...
            this.connectTimeout = ProxyUtils.extractInt(props,
                    "connect_timeout", 0);
            this.withThreadPoolConfiguration(new ThreadPoolConfiguration()
            .withAcceptorThreads(ProxyUtils.extractInt(props,
                    "acceptorthreads",30))
            .withClientToProxyWorkerThreads(ProxyUtils.extractInt(props,
                    "clientworkerthreads",20))
            .withProxyToServerWorkerThreads(ProxyUtils.extractInt(props,
