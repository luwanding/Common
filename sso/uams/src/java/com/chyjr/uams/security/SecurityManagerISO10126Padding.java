package com.chyjr.uams.security;
...
public class SecurityManagerISO10126Padding {
		...
		*/
		...
		public static void main(String[] args) throws Exception {
			byte[] key ="多购 ".getBytes("UTF-8");
//			byte[] key = "123456789012345678901".getBytes();
			System.out.println("key："+ showByteArray(key));
			System.out.println(new String(key));
			byte [] keys = buildKey(new String("多购 "));
			Key k = toKey(keys);
			
//			String data ="DESede数据";
			
			
			System.out.println("加密后数据: byte[]:"+Base64.decode("+qjMmJpNgSn6qMyYmk2BKfqozJiaTYEp6CuzqKY3oyI=")); 
			String data ="cccccccccccc";
			byte[] decryptData = decrypt(new String(Base64.decode("+qjMmJpNgSn6qMyYmk2BKfqozJiaTYEp6CuzqKY3oyI=")).getBytes("UTF-8"), k);
			/*System.out.println("加密前数据: string:"+data);
			System.out.println("加密前数据: byte[]:"+showByteArray(data.getBytes()));
			System.out.println();
			byte[] encryptData = encrypt(data.getBytes(), k);
			System.out.println("加密后数据: byte[]:"+showByteArray(encryptData));
			System.out.println("加密后数据: byte[]:"+Base64.encode(encryptData));
			System.out.println("加密后数据: hexStr:"+HexUtils.toHex(encryptData));
			System.out.println();
