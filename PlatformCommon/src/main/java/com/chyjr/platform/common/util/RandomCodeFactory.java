 ...
 * @Package:      [com.chyjr.platform.common.util.RandomCodeFactory.java] 
 * @ClassName:    [RandomCodeFactory]  
 * @Description:  [随机数字字符串工厂]  
 * @Author:       [jx_xudelin]  
 * @CreateDate:   [Oct 14, 2014 5:14:16 PM]  
 * @UpdateUser:   [jx_xudelin]  
 * @UpdateDate:   [Oct 14, 2014 5:14:16 PM]  
