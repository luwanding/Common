...
public class DesEncryptTool {
	...
	private static Logger logger = Logger.getLogger("DesEncryptTool");
...
//		System.out.println(DesEncryptTool.encrypt("admin","%!##@$%|$#$%(^)$}$*{^*+%"));
		System.out.println(DesEncryptTool.decrypt("8299638287E49EF281EDBE1DDDF0BB9D","%!##@$%|$#$%(^)$}$*{^*+%"));
	}
}
