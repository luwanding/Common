 ...
 * @Package:      [com.chyjr.platform.cache.local.core.DefaultCache.java] 
 * @ClassName:    [DefaultCache]  
 * @Description:  [Local DefaultCache implement]  
 * @Author:       [jx_xudelin]  
 * @CreateDate:   [Oct 15, 2014 1:17:27 PM]  
 * @UpdateUser:   [jx_xudelin]  
 * @UpdateDate:   [Oct 15, 2014 1:17:27 PM]  
...
public class DefaultCache<K, V> implements ICache<K, V> {
    ...
    public DefaultCache(String instanceId, int maxCacheSize, long maxLifeTime) {
