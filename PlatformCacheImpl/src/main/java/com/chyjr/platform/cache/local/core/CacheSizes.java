 ...
 * @Package:      [com.chyjr.platform.cache.local.core.CacheSizes.java] 
 * @ClassName:    [CacheSizes]  
 * @Description:  [cache size manager]  
 * @Author:       [jx_xudelin]  
 * @CreateDate:   [Oct 15, 2014 1:16:37 PM]  
 * @UpdateUser:   [jx_xudelin]  
 * @UpdateDate:   [Oct 15, 2014 1:16:37 PM]  
